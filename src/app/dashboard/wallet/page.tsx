    ...
    if (isLoading) {
      return (
        <div className="mt-16 flex flex-col items-center justify-center text-center">
          ...
          <h2 className="mt-6 text-xl font-semibold">Fetching your certificates...</h2>
          <p className="mt-2 max-w-sm text-muted-foreground">
            This may take a moment depending on the number of certificates.
          </p>
        </div>
      );
    }
    ...
    if (!userCertificates || userCertificates.length === 0) {
      return (
        <div className="mt-16 flex flex-col items-center justify-center text-center">
          ...
          <p className="mt-2 max-w-sm text-muted-foreground">
            You haven&apos;t received any certificates yet. Once you do, they will appear here.
          </p>
        </div>
      );
    }
